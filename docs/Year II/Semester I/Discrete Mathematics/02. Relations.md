...
**Formal Definition:**
Let $A,B$ be sets. A **relation** $R$ from $A$ to $B$ is a subset of $A\times B$. #Discrete-vocab
...
#### Equivalence Classes
**Definition:**
The cells of a partition (which induces $R$) are called the **equivalence classes** of $R$. #Discrete-vocab 
...
### Order Relations
**Definition:**
An order relation generalizes the familiar “orders” like ≤ or ≥ on sets of numbers. #Discrete-vocab 
...
2. An edge exists from $a_1$ “goes up” to $a_2$ if:
	...
	- Under these conditions, we call $a_2$ a **successor** element of $a_1$. #Discrete-vocab 
		- E.g., in our example, $4,6,10,14$ are successors of $2$.
		- $a_1$ is called a **predecessor** of $a_2$. #Discrete-vocab 
		- An element can have multiple predecessors and/or successors.
	- An element with no successors is called **maximal** #Discrete-vocab
		- E.g., in our example, $16,12,18,15,20,14,11,13,17,19$ are maximal.
		- If only one element is maximal, then it is called a **maximum** of $R$. #Discrete-vocab 
			- ![[Excalidraw/02. Relations 2024-01-24 13.28.32.excalidraw]]

The Hasse Diagram of a total order looks like a straight line:
![[Excalidraw/02. Relations 2024-01-24 13.37.33.excalidraw|200]]
